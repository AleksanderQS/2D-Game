...
public class Entity 
{
	...
	public static BufferedImage ENEMY_EN = Game.spritesheet.getSprite(6*64, 64, 64, 64);
	public static BufferedImage ENEMY_FEEDBACK = Game.spritesheet.getSprite(6*64, 128, 64, 64);
