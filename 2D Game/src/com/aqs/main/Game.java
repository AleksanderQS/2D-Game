...
public class Game extends Canvas implements Runnable, KeyListener, MouseListener
{
	...
	public void render() 
	{
		...
		g.drawString("Ammo: " + player.ammo, 30, 100);
		if (gameState == "GAME_OVER") 
		{
			...
			g.setColor(Color.white);
			g.drawString("YOU DIED!", WIDTH * SCALE / 2, HEIGHT * SCALE / 2);
			if(showMessageGameOver) 
			{
				g.drawString("> INTRO TO RESTART <", (WIDTH * SCALE / 2) - 80, (HEIGHT * SCALE / 2) + 60);
			}
		}
		else if (gameState == "MENU")
		{
